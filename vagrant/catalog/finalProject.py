...
## Create a state tokem to prevent request forgery
...
## Display Menu Items for Specific Restaurant
...
def newMenuItem(restaurant_id):
    ...
    if request.method == 'POST':
        if request.form['name'] and request.form['price'] and request.form['course'] and request.form['description']:
            ...
            return redirect('/restaurant/'+str(restaurant.id)+'/menu/new')
    else:
...
def editMenuItem(restaurant_id, menu_id):
    ...
    if request.method == 'POST':
        if request.form['name'] and request.form['price'] and request.form['course'] and request.form['description']:
            ...
            flash("Fill Out Fields")
            return redirect('/restaurant/'+str(restaurant.id)+'/menu/'+str(item.id)+'/edit')
    else:
